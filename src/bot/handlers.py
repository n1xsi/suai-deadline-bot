...
async def cmd_help(message: types.Message):
    help_text = (
        ...
        "🔄 Дедлайн автоматически уберётся из списка, когда пройдёт его <i>срок сдачи</i> или когда отчёт <b>загрузится в ЛК</b>.\n"
        "🔒 Ваши личные данные храню в <u>зашифрованном</u> виде и не передаю их третьим лицам.\n\n"
        "Доступные команды:\n"
